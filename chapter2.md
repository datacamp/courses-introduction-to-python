...
Um auf Elemente von Listen innerhalb einer Liste zuzugreifen, kannst du dieselbe Methode wie zuvor verwenden: eckige Klammern. Das könnte also für die Liste `house` so aussehen:
