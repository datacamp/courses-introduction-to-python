...
`@hint`
- Copy and paste the different code chunks in the shell and run the code to see which output matches the one generated by `np.array([True, 1, 2]) + np.array([3, 4, False])`.
