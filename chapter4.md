...
`@hint`
- Kopiere die verschiedenen Code-Bausteine und füge sie in die IPython Shell ein. Drücke die **Eingabetaste**, um den Code auszuführen und zu sehen, welche Ausgabe mit der von `np.array([True, 1, 2]) + np.array([3, 4, False])` übereinstimmt.
