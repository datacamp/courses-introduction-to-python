...
description: >-
  ...
  data exploration.
attachments:
  slides_link: 'https://projector-video-pdf-converter.datacamp.com/25616/chapter4.pdf'
lessons:
  - nb_of_exercises: 5
    title: Numpy
  - nb_of_exercises: 5
...
`@hint`
- Copy the different code chunks and paste them in the IPython Shell. Run the code (hit **Enter** for web users) and see which output matches the one generated by `np.array([True, 1, 2]) + np.array([3, 4, False])`.
