...
- ¿Los jugadores altos tienden a ser más pesados? Utiliza `np.corrcoef()` para almacenar la correlación entre la primera y segunda columna de `np_baseball` en `corr`. Sustituye `None` por el código correcto.
