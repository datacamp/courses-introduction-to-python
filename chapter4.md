...
`@hint`
- Copy the different code chunks and paste them in the shell. Hit **enter** to run the code and see which output matches the one generated by `np.array([True, 1, 2]) + np.array([3, 4, False])`.
