...
- `.remove()`die [das](https://docs.python.org/3/library/stdtypes.html#typesseq-mutable) erste Element einer Liste [entfernt](https://docs.python.org/3/library/stdtypes.html#typesseq-mutable), das mit der Eingabe übereinstimmt, und
