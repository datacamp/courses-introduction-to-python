...
`@hint`
- Prueba las distintas declaraciones de importación en el terminal `my_inv([[1, 2], [3, 4]])`ython y comprueba cuál de ellas hace que la línea IP se ejecute sin errores. Pulsa **Intro** para ejecutar el código que has escrito.
