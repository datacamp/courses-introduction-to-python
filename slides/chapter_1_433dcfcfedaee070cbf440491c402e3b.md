...
video_link:
  mp3: >-
    https://videos.datacamp.com/mp3/translations/course_735/de-DE/9ec17427-ed61-48b8-97cb-299c6ecf0e2c-578c13c221a3363da0c94bcbe4a1f05d.mp3
---
...
`@part1`
- Spezifischer Name (Groß-/Kleinschreibung beachten)

- Wert mittels Variablennamen aufrufen{{1}}
...
`@script`
Dazu gibst du einer Variable einen bestimmten Namen und beachtest dabei die Groß- und Kleinschreibung. Sobald du solch eine Variable erstellt oder deklariert hast, kannst du ihren Wert aufrufen, indem du den Variablennamen eingibst.

Angenommen, du misst deine Größe und dein Gewicht: Du bist einen-Meter-neunundsiebzig groß und wiegst achtundsechzig-Komma-sieben Kilogramm. Du kannst diesen Werten die Variablen „height“ und „weight“ über ein Gleichheitszeichen zuweisen:
...
`@script`
Python hat noch jede Menge andere Datentypen. Die am häufigsten genutzten sind „strings“ (also Zeichenfolgen) und „booleans“ (also boolesche Werte).

In Python wird ein „string“ dazu genutzt, Text darzustellen. Wir können sowohl einfache als auch doppelte Anführungszeichen verwenden, um einen String zu erstellen, wie wir an diesen Beispielen sehen können. Wenn wir den Typ der letzten Variable ausgeben, lesen wir „s-t-r“, die Kurzform für „string“.

Der boolesche Wert ist ein Typ, der entweder „true“ oder „false“ sein kann. Man könnte vereinfacht auch „Ja“ und „Nein“ dazu sagen. Boolesche Werte werden für dich noch sehr nützlich sein, zum Beispiel um deine Daten zu filtern.
...
`@script`
Schauen wir uns diese Codezeile an: Hier werden zwei ganze Zahlen addiert. In der nächsten werden zwei Zeichenfolgen addiert.
...
`@script`
Doch zunächst wollen wir ein bisschen deine neuen Programmierkenntnisse testen.
