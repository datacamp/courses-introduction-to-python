...
video_link:
  mp3: >-
    https://videos.datacamp.com/mp3/translations/course_735/es-ES/21ec9eec-1200-48c4-b0f0-106da449d3b6-aeafa88ba43c12a729a82a0fde8028a8.mp3
---
...
`@script`
Si preguntas por el tipo de estas matrices, Python te dice que son numpy punto nd array. numpy punto indica que es un tipo que se definió en el paquete numpy. nd array alude a una matriz n-dimensional. Las matrices np guión bajo height y np guión bajo weight son unidimensionales, pero es perfectamente posible crear matrices bidimensionales, tridimensionales e incluso de siete dimensiones. En este vídeo, solo nos quedaremos con las bidimensionales.
...
Si ahora muestras por pantalla np guión bajo 2d, verás que es una estructura de datos rectangular: cada sublista de la lista original corresponde a una fila en el array bidimensional de NumPy. Al ejecutar np guión bajo 2d punto shape, puedes comprobar que, efectivamente, tenemos 2 filas y 5 columnas. shape es lo que llamamos un atributo del array np guión bajo 2d, y sirve para darte más información sobre la forma que tiene la estructura de datos.
...
`@script`
Básicamente, seleccionas la fila y, a continuación, desde esa fila seleccionas otra cosa.
...
Por último, las matrices numpy 2D te permiten realizar cálculos por elementos, del mismo modo que lo hacías con las matrices numpy 1D. 
...
`@script`
Eso es algo con lo que puedes experimentar en los ejercicios, además de crear y formar subconjuntos de matrices numpy 2D. ¡Emocionante!
