...
video_link:
  mp3: >-
    https://videos.datacamp.com/mp3/translations/course_735/de-DE/a0d0c4a9-d149-4309-9384-be7132480792-b22a4a7050742a189f4bec4dec740d84-2.mp3
---
...
`@script`
Lass uns erneut die Körpergrößen deiner Familie und dir als Beispiel nehmen. Angenommen, du hast auch alle nach ihrem Gewicht gefragt. Das ist zwar nicht besonders höflich, aber für die Wissenschaft tut man alles, oder? Am Ende hast du zwei Listen: Größe und Gewicht. Die erste Person ist „eins-Komma-sieben-drei“ Meter groß und wiegt fünfundsechzig-Komma-vier Kilogramm.
...
- Alternative zur Python-Liste: NumPy-Array{{2}}
...
Um NumPy dann in deiner Python-Sitzung zu verwenden,
...
`@script`
kannst du das NumPy-Paket wie folgt importieren.
...
`@script`
Du solltest trotzdem gut aufpassen. Zunächst kann NumPy das alles nur deshalb so einfach ausführen, weil es davon ausgeht, dass dein NumPy-Array nur Werte eines einzigen Typs enthält. Es ist entweder ein Array mit Gleitkommazahlen, ein Array mit booleschen Werten und so weiter. Wenn du versuchst, ein Array mit verschiedenen Datentypen zu erstellen, wie zum Beispiel hier, wird das resultierende NumPy-Array nur einen einzigen Typ enthalten. In diesem Fall ist das eine Zeichenfolge, ein string. Der boolesche Wert und die Gleitkommazahl wurden beide in Zeichenfolgen umgewandelt.
...
`@script`
kannst du mit NumPy-Arrays fast genauso arbeiten wie mit normalen Python Listen. Wenn du Elemente aus deinem Array anzeigen lassen willst, kannst du zum Beispiel eckige Klammern benutzen. Angenommen, du benötigst den BMI für die zweite Person, also bei Index „Eins“. Dazu würdest du wie gezeigt vorgehen.

Speziell für NumPy gibt es noch eine andere Möglichkeit, Listen zu unterteilen: mit einem Array mit booleschen Werten. Angenommen, du möchtest alle BMI-Werte im Array „BMI” ermitteln, die über dreiundzwanzig liegen. Ein erster Schritt ist, das Größer-als-Zeichen zu benutzen:

Das Ergebnis ist ein NumPy-Array mit booleschen Werten: Uns wird „true“ angezeigt, wenn der entsprechende BMI über dreiundzwanzig liegt, und „false“, wenn er darunter liegt. Als Nächstes kannst du dieses boolesche Array in eckigen Klammern verwenden, um Teilmengen zu bilden. Nur die Elemente in „BMI“, die über dreiundzwanzig liegen, also für die der entsprechende boolesche Wert „true“ ist, werden ausgewählt. Es gibt nur einen BMI, der über dreiundzwanzig liegt. Also haben wir letztendlich ein NumPy-Array mit nur einem Wert, nämlich diesem BMI.

Wenn wir die Ergebnisse eines Vergleichs nutzen, um Daten auszuwählen, gewinnen wir oft überraschende Erkenntnisse.
...
`@script`
Mehr darüber erfährst du in den nächsten Übungen.
