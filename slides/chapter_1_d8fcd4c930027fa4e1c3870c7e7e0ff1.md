...
`@part1`
![Interface DataCamp](https://assets.datacamp.com/production/repositories/288/datasets/729574d2168960686381caefe79baf5978e27d0d/liveexercise.gif)
...
- Usage général : construire n'importe quoi{{2}}
...
![Calculs dans le shell ython IPde DataCamp](https://assets.datacamp.com/production/repositories/288/datasets/cee32b788a62e4b9a1234ccde56ac9ebb49cfa72/shelladdition.gif = 95)
...
`@part1`
![GIF: tapez 4 + 5 dans le script et cliquez sur soumettre la réponse. Aucune sortie n'est affichée](https://assets.datacamp.com/production/repositories/288/datasets/2f96e979012e15329cc158d1e0f496aac3539f45/scriptnoprint.gif = 95)
...
- Utilisez `print()` pour générer la sortie d'un script
...
`@part1`
![Capture d'écran de l'interface de DataCamp](https://assets.datacamp.com/production/repositories/288/datasets/a9e8440bb8fbd49e4a73e4c36ef1cd677c0dd55f/pyexercise.png)
