...
video_link:
  mp3: >-
    https://videos.datacamp.com/mp3/translations/course_735/es-ES/5bdd3504-ea9e-4977-b3fd-c95f9e6405b7-9833dc3fa893d5aa0c4a49fd24357b25.mp3
---
...
`@part1`
![Interfaz DataCamp](https://assets.datacamp.com/img/translations/es-ES/production/repositories/288/datasets/729574d2168960686381caefe79baf5978e27d0d/liveexercise.gif)
...
- Uso general: construir cualquier cosa{{2}}
...
`@script`
terminal Python, un lugar donde puedes escribir código Python y ver los resultados inmediatamente. Este terminal está integrado en la interfaz de ejercicios de DataCamp. Empecemos por algo sencillo y usemos Python como calculadora.
...
![Cálculos en el shell IPython de DataCamp](https://assets.datacamp.com/img/translations/es-ES/production/repositories/288/datasets/cee32b788a62e4b9a1234ccde56ac9ebb49cfa72/shelladdition.gif = 95)

`@script`
Si escribo 4 + 5 y pulso Intro, Python interpreta lo que he tecleado y muestra el resultado del cálculo: 9. La consola de Python (Python shell) que estamos usando aquí no es la original; en su lugar utilizamos IPython (abreviatura de Interactive Python). Es una especie de versión vitaminada del Python convencional que nos vendrá de maravilla más adelante.

IPython fue creado por Fernando Pérez y forma parte del ecosistema Jupyter. Además de permitirte trabajar con Python de manera interactiva, también sirve para ejecutar los llamados
...
`@part1`
![GIF: escribe 4 + 5 en el script y pulsa enviar respuesta. No se muestra ninguna salida.](https://assets.datacamp.com/img/translations/es-ES/production/repositories/288/datasets/2f96e979012e15329cc158d1e0f496aac3539f45/scriptnoprint.gif = 95)
