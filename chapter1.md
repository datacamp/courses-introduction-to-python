...
```{python}
Ex().check_correct(
  has_printout(1, not_printed_msg = "Have you used `{{sol_call}}` to print out the sum of 7 and 10?"),
  check_function('print', 1, signature=False).check_args(0).has_equal_value()    
)
