...
`@instructions`
- Affichez la somme de `4 + 5`.
- Affichez le résultat de la soustraction de `5` à `5`.
- Affichez le résultat de la multiplication de `3` par `5`.
- Affichez le résultat de la division de `10` par `2`.
